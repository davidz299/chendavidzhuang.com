    ...
    return (
      <Container>
        <Section>
          <Image
            alt="Chen"
            src="/static/images/Chen-background.png"
            width="325"
            height="325"
            placeholder="blur"
        ...
        <Section>
          ...
          <Paragraph>
            Currently, I'm working as a <strong> Software Developer</strong> at 
            <strong> Ericsson</strong>.
          </Paragraph>
          <Paragraph>
            I was also recently featured on <strong>CBC News </strong> for acheiving a <strong>100% average:</strong> <a href="https://www.cbc.ca/news/canada/toronto/brampton-high-school-student-graduates-grade-12-perfect-average-2022-1.6507093">CBC News Article</a>.
          </Paragraph>
        </Section>
      </Container>
    )
  ...
  return (
    <>
      <Head>
        ...
        <meta content="https://chendavidzhuang.com" property="og:url" />
